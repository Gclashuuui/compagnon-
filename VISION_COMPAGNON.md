...
Le compagnon doit donner l'impression d'une petite vie partagee, jamais d'une
liste de barres a remplir. Trois regles guident les ajouts : il montre avant que
l'interface explique, il se souvient de moments plutot que de statistiques, et
il ne punit jamais quelqu'un qui ne s'est pas connecte.

## La boucle quotidienne

Le carnet rassemble trois attentions tres simples : prendre soin de lui, partager
un geste d'affection et partir un moment ensemble. Une seule attention de chaque
sorte marque le sceau du jour. Completer les trois provoque une petite joie, mais
ne donne aucun objet exclusif : le plaisir vient de sa reaction, pas d'une corvee.

Les missions restent differentes. Elles proposent des aventures et des situations
nouvelles ; elles ne servent pas de tutoriel quotidien.
...
- Une petite vignette pour le premier vol, le premier orage, le premier soin et
  le premier ami.
- Une phrase rare au retour : ce qu'il a fait ou l'endroit ou il a attendu.
...
- Les jauges deviennent des mots quand elles sont critiques : « affame »,
  « epuise », « inquiet ».
- La roue place les actions favorites pres du centre et range les gestes rares
...
- Regarder un objet inconnu avant de s'en approcher, puis le reconnaitre plus tard.
- Deux compagnons familiers peuvent dormir ou jouer a proximite sans se traverser.
- Chaque caractere modifie le rythme, la distance et la facon de demander, jamais
  seulement un pourcentage cache.

## Ce qui est deja mis en place

- Les trois sceaux quotidiens dans le carnet, avec explication au survol.
- L'XP de balade accordee une fois par minute de marche, avec plafond journalier.
